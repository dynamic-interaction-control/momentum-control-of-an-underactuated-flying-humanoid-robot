function arrowHandle = arrow3D_redraw(pos, deltaValues, colorCode, stemRatio,cylinderRadius,hStem,hHead)
...
%     cylinderRadius = 0.05*srho;
    ...
    coneRadius = cylinderRadius*3;
    incr = 4;  %---- Steps of cone increments
    coneincr = coneRadius/incr;    
    [coneX, coneY, coneZ] = cylinder(cylinderRadius*5:-coneincr:0);  %---------- CONE 
    ...
    %************************************************************************************************************    
     ...
     if(nargin<=5)
        ...
        hold off;  
              ...
              set(hStem,'xdata',stemX,'ydata',stemY,'zdata',stemZ,'FaceColor', colorCode);
              set(hHead,'xdata',headX,'ydata',headY,'zdata',headZ,'FaceColor', colorCode);
     end
