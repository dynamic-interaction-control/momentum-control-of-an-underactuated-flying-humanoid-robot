function [viz,model] = open_robot_idyntree_visualizer(name)
    ...
    mdlLoader.loadReducedModelFromFile('model/icub/model.urdf',consideredJoints);
    ...
    viz.addModel(mdlLoader.model(),name);
